 ...
 */
namespace xb\db\sharding\split;

use xb\db\base\Sharding as InterfaceSharding;
use xb\db\sharding\Split as AbstractSplit;
 ...
 */
class Date extends AbstractSplit implements InterfaceSharding {
